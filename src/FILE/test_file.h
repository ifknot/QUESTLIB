...
#define TEST_FILE_LIST &test_file_extension_normal, &test_file_extension_no_ext, &test_file_extension_edge_cases, &test_file_size_basic, &test_file_size_empty, &test_eof_detection, &test_invalid_handle_behavior
