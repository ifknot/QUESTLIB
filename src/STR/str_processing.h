...
str_size_t str_read_word(const char* string, str_size_t* offset, char* word, const str_size_t limit);

str_size_t str_read_line(const char* string, str_size_t* offset, char* line, const str_size_t limit);
