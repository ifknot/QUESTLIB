...
#define PARSE_TESTS &test_arena_creation, &test_basic_allocation, &test_allocation_limits, &test_deallocation, &test_zero_allocation, &test_null_arena_handling, &test_arena_dump
